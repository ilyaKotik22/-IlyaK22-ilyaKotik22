...
### 💬 Обо мне
Я учусь в колледже и активно осваиваю веб-разработку через YouTube-курсы, практику и хакатоны. Мой стек пока небольшой, но я быстро учусь и горю желанием создавать крутые проекты!
🔥 Мой опыт:
✅ Участник 3 хакатонов – работал в команде, учился решать задачи на время.
✅ Разрабатываю пет-проекты на HTML, CSS, JavaScript, TypeScript, React.
